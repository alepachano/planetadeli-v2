          ...
          <Col>
            <div>
              ...
              <div className="row-description flex">
                ...
                {isAdded ? <Button onClick={onAdd} variant="outline-primary"><Link to={'/cart'}>Terminar la compra</Link></Button> : <Button className="buttonAddToCart" onClick={() => { onAdd(id, quantity, price, { "item": name, "cantidad": quantity, "id": id, "price": (price * quantity) }) }} variant="danger">Agregar al carrito</Button>}
              </div>
            </div>
          </Col>
        </Row>
